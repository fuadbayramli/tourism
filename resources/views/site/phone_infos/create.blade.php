            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header border bottom">
                        <h4 class="card-title">Create Phone Info</h4>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('phone-infos.store') }}"
                        ...
                        <div class="row">
                            <div class="col-sm-9 offset-sm-1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="notes" class="form-control" id="editor1"></textarea>
                                ...
                                <div class="col-sm-12">
                                    <div class="text-sm-center">
                                        <button class="btn btn-gradient-success" id="send">Create</button>
                                    </div>
                                </div>
                            </div>
                        </div>
